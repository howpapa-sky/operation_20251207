      ...
      <form onSubmit={handleSearch} className="flex-1 max-w-xl">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 focus:bg-white transition-all"
          />
          {searchQuery && (
            <button
              type="button"
